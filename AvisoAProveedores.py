...
try:
    ...
    for codProveedor, proveedor_info in proveedores.items():
        ...
        contenido_html = """
            ...
            <body>
              <h2>Atención, existen artículos para su inmediata entrega.</h2>              
              <table>
                <tr class="cabecera">
        ...
        for comprobante in proveedor_info['comprobantes']:
            if comprobante['cantidad_um1'] != 0.0 or comprobante['cantidad_um2'] != 0.0:
                ...
                elif diferencia_dias < 7 and diferencia_dias >= 1:
                    contenido_html += """
                        <td class="advertencia-container"><p class="advertencia-text">{fecha_entrega}</p></td>
                    </tr>
                    """.format(fecha_entrega=comprobante['fecha_entrega'])
                else:
                    contenido_html += """
        ...
        # destinatarioCco = ['javieruroz@imcestari.com', 'mcelli@imcestari.com']

        # De prueba
        destinatario = ['javieruroz@imcestari.com']
        destinatarioCco  = ['javieruroz@imcestari.com']
        ...
        mensaje['Bcc'] = ", ".join(destinatarioCco)
